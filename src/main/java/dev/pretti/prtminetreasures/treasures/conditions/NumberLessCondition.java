...
public class NumberLessCondition extends NumberComparator
{
  /**
   * Construtor da classe
   */
  public NumberLessCondition(PlaceholderApiIntegration placeholderApiIntegration, String input, String output)
  {
  ...
  {
    return EnumConditionType.NUMBER_LESS;
  }
}
