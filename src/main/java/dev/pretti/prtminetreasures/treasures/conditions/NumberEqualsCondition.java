...
public class NumberEqualsCondition extends NumberComparator
{
  /**
   * Construtor da classe
   */
  public NumberEqualsCondition(PlaceholderApiIntegration placeholderApiIntegration, String input, String output)
  {
  ...
  {
    return EnumConditionType.NUMBER_EQUALS;
  }
}
